const projects = [
  {
    name: "COVIWEB",
    imageUrl: "https://github.com/nibble0101/portfolio/blob/master/src/main/projects/images/coviweb.jpg?raw=true",
    altText: "coviWeb",
    projectUrl: "https://coviweb.netlify.app/",
    sourceCodeUrl: "https://github.com/nibble0101/coviweb",
    key: "coviweb",
    description: "coviWeb is a Single Page Application (SPA) which displays up-to-date COVID-19 statistics. It was built using React.js, d3.js and CSS.",
  },
  {
    name: "FILMMAZE",
    ...
    key: "filmMaze",
    description: "FilmMaze is a Single Page Application(SPA) which displays a list of Movies, TV Shows and Personalities in the movie industry. It was built using React.js and CSS.",
  },
  {
    name: "CLOUDYGEM",
